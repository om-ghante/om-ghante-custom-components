...
function _arrayWithHoles(r) { if (Array.isArray(r)) return r; } // components/others/CustomDatePicker.jsx
var CustomDatePicker = function CustomDatePicker(_ref) {
  ...
  var toggleDatePicker = function toggleDatePicker(e) {
    e.stopPropagation();
    setDatePickerOpen(function (prev) {
      return !prev;
    });
  };
  var CustomInput = /*#__PURE__*/(0, _react.forwardRef)(function (_ref2, ref) {
    ...
    return /*#__PURE__*/_react["default"].createElement("div", {
      ...
      onClick: function onClick(e) {
        e.stopPropagation();
        _onClick(); // open/close via DatePicker internal logic
      },
